...
ARTICLES: list[dict[str, object]] = [
    {
        ...
        "hotel_intro": [
            "ここでは、ひとり旅での動きやすさを基準に3軒に絞りました。未宿泊の施設は体験談として書かず、公式情報ベースの比較候補として扱っています。",
        ],
        "hotels": [
            {
    ...
    },
    {
        ...
        "hotel_intro": [
            "ここでは、離島観光を優先する旅を前提に、使い分けしやすい3軒を選びました。",
        ],
        "hotels": [
            {
                "name": "南の美ら花ホテルミヤヒラ",
    ...
    },
    {
        ...
        "hotel_intro": ["ここでは、雰囲気の違いがはっきり分かる3軒を選びました。"],
        "hotels": [
            {
    ...
    },
    {
        ...
        "hotel_intro": ["ここでは、用途がきれいに分かれる3軒を選びました。"],
        "hotels": [
            {
                "name": "宮古島東急ホテル＆リゾーツ",
                "paragraphs": [
    ...
    },
    {
        ...
        "hotel_intro": ["ここでは、旅の空気感が分かりやすく変わる3軒を選びました。"],
        "hotels": [
            {
